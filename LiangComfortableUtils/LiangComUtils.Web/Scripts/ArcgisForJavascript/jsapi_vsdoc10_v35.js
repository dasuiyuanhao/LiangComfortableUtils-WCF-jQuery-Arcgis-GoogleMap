...
esri.Map.prototype = 
{
    ...
    getLayersVisibleAtScaleRange: function (scale) {
        /// <summary>Return an array of layers visible at the current scale.</summary>
        /// <param name="scale" type="Number" optional="false">The input scale used to determine if layers are visible at that scale or not.</param>
        /// <return type="Layer[]">Layer[]</return>
    },
    getLevel: function () {
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"basemap-change","click","dbl-click","extent-change","key-down","key-up","layer-add","layer-add-result","layer-add-result","layer-remove","layer-reorder","layer-resume","layers-add-result","layers-removed","layers-reordered","load","mouse-down","mouse-drag","mouse-drag-end","mouse-drag-start","mouse-move","mouse-out","mouse-over","mouse-up","mouse-wheel","pan","pan-end","pan-start","reposition","resize","time-extent-change","unload","update-end","update-start","zoom","zoom-end","zoom-start"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
    panDown: function () {
...
esri.dijit.InfoWindowLite = function (params,srcNodeRef) {
    /// <summary>Create a new Info Window Lite.</summary>
    /// <param name="params" type="String" optional="true">Specify the parameters used to create the info window. View the options list for valid values.</param>
    /// <param name="srcNodeRef" type="String" optional="false">Reference or id of the HTML element where the widget should be rendered.</param>
...
esri.dijit.Legend = function (srcNodeRef,params) {
...
esri.geometry.lngLatToXY = function (long,lat,isLinear) {
    /// <summary>Translates the given Web Mercator coordinates to longitude and latitude. By default, the returned longitude is normalized so that it is within -180 and +180. Setting the third argument to true will prevent the normalization.</summary>
...
esri.layers.TiledMapServiceLayer = function () {
    /// <summary>The base class for all tiled map service layers. (As of v1.2)TiledMapServiceLayer has no constructor. Use ArcGISTiledMapServiceLayer instead.</summary>
    /// <field name="fullExtent" type="Extent">Full extent as defined by the map service.</field>
    /// <field name="initialExtent" type="Extent">Initial extent as defined by the map service.</field>
    /// <field name="spatialReference" type="SpatialReference">The spatial reference of the map service. See Projected Coordinate Systems and Geographic Coordinate Systems for the list of supported spatial references.</field>
